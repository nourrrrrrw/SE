    ...
    <>
      ...
      {cycleToast && (
        <div style={{
          ...
          <button onClick={() => setCycleToast(null)} style={{ marginLeft: 18, background: 'none', border: 'none', color: '#1E40AF', fontWeight: 700, fontSize: 22, cursor: 'pointer' }}>×</button>
        </div>
      )}
      {cycleToast2 && (
        <div style={{
          ...
          <span style={{ fontSize: 24, marginRight: 10 }}>🎉</span>
          <span>{cycleToast2}</span>
          <button onClick={() => setCycleToast2(null)} style={{ marginLeft: 18, background: 'none', border: 'none', color: '#065F46', fontWeight: 700, fontSize: 22, cursor: 'pointer' }}>×</button>
        </div>
      )}
