...
const CompanyRegistration = () => {
  ...
  const handleLogoChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setFormData(prevState => ({
          ...prevState,
          logo: reader.result // Store as base64 string
        }));
      };
  ...
  const handleSubmit = async () => {
    ...
    const finalIndustry = formData.industry === 'Other' ? formData.customIndustry : formData.industry;
      ...
      // Register the company using the handler from App.js
      const success = await registerCompany(companyData);
      if (success) {
        ...
        return (
          <div style={{ textAlign: 'center', padding: '20px' }}>
            ...
            <p style={{ 
              ...
              Your company has been registered successfully. You can now login to access the system.
            </p>
            <button 
